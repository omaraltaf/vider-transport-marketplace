      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <main className="lg:col-span-3">
            ...
            {/* Driver Listings */}
            {!isLoading && !error && results?.driverListings && results.driverListings.length > 0 && (
              <div className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Driver Listings</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {results.driverListings.map((listing: any) => (
                    <div
                      key={listing.id}
                      ...
                      <div className="mt-4 space-y-2">
                        ...
                        {listing.company && (
                          <div className="flex items-center text-sm text-gray-500">
                            ...
                            {listing.company.fylke}, {listing.company.kommune}
                          </div>
                        )}
                        ...
                        {listing.aggregatedRating && (
                          <div className="flex items-center text-sm text-gray-500">
                            ...
                            {listing.aggregatedRating.toFixed(1)} rating
                          </div>
                        )}
                      </div>
                    </div>
