...
export default function AdminAnalyticsPage() {
  ...
  return (
    <AdminPanelPage>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">{analytics?.activeListings.total}</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">{analytics?.bookings.total}</p>
              <p className="text-xs text-gray-500 mt-1">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">{analytics?.bookings.active}</p>
              <p className="text-xs text-gray-500 mt-1">
        ...
        <div className="space-y-4">
          <div>
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="font-medium text-gray-900">{analytics?.bookings.completed}</span>
            </div>
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="font-medium text-gray-900">{analytics?.bookings.active}</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
          ...
          <div>
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="font-medium text-gray-900">{analytics?.bookings.pending}</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
      ...
      {/* Top Rated Providers */}
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Top Rated Providers</h2>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {analytics?.topRatedProviders.map((provider, index) => (
                <tr key={provider.companyId} className="hover:bg-gray-50">
